...
namespace PatientsWebApplication.Controllers
{
    public class DiagnosesController : Controller
    {
        ...
        public DiagnosesController(PatientContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DiagnosisID,Name,Description")] Diagnosis diagnosis)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DiagnosisID,Name,Description")] Diagnosis diagnosis)
        {
